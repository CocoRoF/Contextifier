# contextifier/core/processor/hwp5_helper/hwp5_chart_extractor.py
"""
HWP 5.0 Chart Extractor

Extracts chart data from HWP 5.0 files.
...
class HWP5ChartExtractor(BaseChartExtractor):
    """
    Chart extractor for HWP 5.0 files.
    ...
    def extract_all_from_file(
        ...
        """
        Extract all charts from an HWP 5.0 file.
        ...
        try:
            ...
            logger.info(f"Extracted {len(charts)} charts from HWP 5.0 file")
            
        except Exception as e:
            logger.error(f"Error extracting charts from HWP 5.0: {e}")
