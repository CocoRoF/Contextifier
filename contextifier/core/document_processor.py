...
class DocumentProcessor:
    ...
    def chunk_text(
        ...
        *,
        ...
        """
        from contextifier.chunking.chunking import create_chunks
    ...
    def clean_text(text: str) -> str:
        ...
        Returns:
            Cleaned text
        """
        from contextifier.core.functions.utils import clean_text as _clean_text
    ...
    def clean_code_text(text: str) -> str:
        ...
        Returns:
            Cleaned code text
        """
        from contextifier.core.functions.utils import clean_code_text as _clean_code_text
    ...
    def _create_image_processor(
        ...
        """
        from contextifier.core.functions.img_processor import create_image_processor
    ...
    def _get_handler_registry(self) -> Dict[str, Callable]:
        ...
        try:
            from contextifier.core.processor.image_file_handler import ImageFileHandler
